			...
			<div class="row mb-2">
				...
				<div class="col-sm-6">
					<ol class="breadcrumb float-sm-right">
						...
						<li class="breadcrumb-item"><a href="<?= base_url('peserta/transaksi'); ?>">Histori Transaksi</a></li>
		...
		<div class="container-fluid">
						...
						<div class="card-body">
							...
							<div class="row">
								<div class="col-md-3 col-sm-6 col-12">
									<div class="info-box">
										<span class="info-box-icon bg-primary shadow"><i class="fas fa-cart-plus"></i></span>
								...
								<div class="col-md-3 col-sm-6 col-12">
									<div class="info-box">
										<span class="info-box-icon bg-primary shadow"><i class="fas fa-wallet"></i></span>
								...
								<div class="col-md-3 col-sm-6 col-12">
									<div class="info-box">
										<span class="info-box-icon bg-primary shadow"><i class="fas fa-money-check"></i></span>
								...
								<div class="col-md-3 col-sm-6 col-12">
									<div class="info-box">
										<span class="info-box-icon bg-primary shadow"><i class="fas fa-question"></i></span>
					...
					<div class="card card-primary">
						...
						<div class="card-body p-0">
							...
							<div class="card-footer">
								<small class="text-bold text-danger">(<i>Transaksi secara otomatis akan dibatalkan jika melebihi batas waktu pembayaran</i>)*</small>
							</div>
						</div>
					</div>
					<!-- /.card -->
			...
			<div class="card-footer">
				<div class="float-right">
					<a href="<?= base_url('peserta/transaksi'); ?>" class="btn btn-default text-bold"><i class="fas fa-arrow-circle-left"></i> Kembali</a>
				</div>
			</div>
		</div><!-- /.container-fluid -->
