            ...
            <div class="col-md-12">
                <div class="card card-primary card-outline">
                    <div class="card-header">
                        <a href="<?= base_url('admin/notifikasi'); ?>" class="btn btn-default btn-sm text-bold float-right"><i class="fas fa-sync-alt"></i> Refresh</a>
                                    ...
                                    <?php foreach ($notif as $n) : ?>
                                        ...
                                        <tr>
                                            ...
                                            <td class="mailbox-name">
                                                <p class="<?= $text; ?>"><a href="<?= base_url('admin/notifikasi/read_msg/' . $n['ID_NOT']); ?>"><?= $n['TITTLE_NOT']; ?> <?= $not_read; ?></a></p>
                                            </td>
                                            ...
                                            <td>
                                                <a href="<?= base_url('admin/notifikasi/del_msg/' . $n['ID_NOT']); ?>" class="btn btn-danger btn-sm"><i class="far fa-trash-alt"></i> Hapus</a>
                                            </td>
                                        </tr>
                                    <?php endforeach; ?>
                                </tbody>
