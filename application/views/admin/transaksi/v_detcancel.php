						...
						<div class="card-body">
							...
							<div class="row">
								<div class="col-md-3 col-sm-6 col-12">
									<div class="info-box">
										<span class="info-box-icon bg-danger shadow"><i class="fas fa-cart-plus"></i></span>
								...
								<div class="col-md-3 col-sm-6 col-12">
									<div class="info-box">
										<span class="info-box-icon bg-danger shadow"><i class="fas fa-wallet"></i></span>
								...
								<div class="col-md-3 col-sm-6 col-12">
									<div class="info-box">
										<span class="info-box-icon bg-danger shadow"><i class="fas fa-money-check"></i></span>
								...
								<div class="col-md-3 col-sm-6 col-12">
									<div class="info-box">
										<span class="info-box-icon bg-danger shadow"><i class="fas fa-question"></i></span>
